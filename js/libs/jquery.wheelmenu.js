...
! function ($) {
    ...
    $.fn.centerAround = function (button,el) {
        ...
        this.css("top",  - ((width+el.outerHeight()) / 2) + "px");
        this.css("left",  buttonX - (el.outerWidth() / 2) + "px");
        return this;
    }
